...
function createTaskCard(task) {
  ...
  const divh5 = document.createElement("h6");
  const divh6 = document.createElement("h6");
...
function handleAddTask(event) {
 ...
 // Above I hide the modal and cleared it 
  ...
  // important to refresh the scrren when dealing with local storage on same page. 
  // use window.location.reload()
  // This stops reitteration 
  // Stuck on this problem for hours !!!
}
